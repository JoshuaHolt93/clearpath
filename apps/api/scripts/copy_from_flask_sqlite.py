...
PHASE1_ENCRYPTED_COLUMNS = {
    ...
    "fixed_expense_item": ["name", "notes"],
    "variable_expense_item": ["name", "notes"],
    "recurring_forecast_template": ["name", "notes"],
    "forecast_item": ["description", "notes"],
    "goal": ["name"],
    "insight": ["title", "body"],
...
def _base_defaults() -> dict[str, dict[str, Any]]:
    ...
    return {
        ...
        "monthly_plan": {
            ...
            "safe_to_spend_target": 0.0,
            "created_at": now,
            "updated_at": now,
        },
        "monthly_budget_snapshot": {
            "planned_income": 0.0,
            "planned_fixed_expenses": 0.0,
            "planned_variable_expenses": 0.0,
            "planned_savings": 0.0,
            "planned_debt_payment": 0.0,
            "planned_taxes": 0.0,
            "planned_retirement": 0.0,
            "planned_safe_to_spend": 0.0,
            "expected_cash_flow": 0.0,
            "budget_remaining": 0.0,
            "actual_income": 0.0,
            "actual_fixed_expenses": 0.0,
            "actual_variable_expenses": 0.0,
        ...
        "loan_plan": {
            ...
            "term_months": 360,
            "term_unit_preference": "months",
            "regular_payment": 0.0,
            "extra_payment_one": 0.0,
            "extra_payment_two": 0.0,
        ...
        "onboarding_profile": {
            ...
            "tax_additional_type": "amount",
            "tax_additional_rate": 0.0,
